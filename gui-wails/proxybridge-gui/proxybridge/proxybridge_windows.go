...
// Stub implementation for Windows GUI builds.
// The real WinDivert-based ProxyBridgeCore.dll is loaded at runtime via syscall,
// not compile-time cgo — this stub implements the same API for the GUI.
//
//go:build windows
// +build windows
...
// ActivateRealBridge is a no-op stub on Windows.
